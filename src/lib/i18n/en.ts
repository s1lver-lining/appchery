...
export const en = {
	...
	auto: {
		...
		aiming: 'Frame the target so the whole face and its gold are in view.',
		noFace: 'No target face found yet.',
		settling: 'Measuring the face. Square up to the boss for the truest reading.',
		watching: 'Watching the face. {n} possible arrows.',
		angle: 'Reading arrows at an angle is harder. Move round towards the front of the boss.',
		keep: 'Keep {n}',
