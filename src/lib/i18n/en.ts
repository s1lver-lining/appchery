...
export const en = {
	...
	score: {
		...
		plotHint: 'Tap where the arrow landed.',
		movePlot: 'Place the ringed arrow again.',
		placePlot: 'Plot where this arrow landed.',
	...
	settings: {
		...
		themeSystem: 'System',
		watch: 'Watch',
		watchHint: 'Score a round from your wrist. The phone keeps the record and works out every score.',
		watchConnect: 'Connect a watch',
		watchConnecting: 'Looking for a watch',
		...
		watchNoApi: 'This browser cannot connect a watch. Chrome and Edge can; Firefox and Safari have no Bluetooth.',
		watchInsecure: 'A watch needs a secure connection. Open appchery.com rather than an address on your network.',
		watchNoAdapter: 'Bluetooth is off, or this device has none.',
...
insetHint:
	...
	running: {
		...
		kmh: 'km/h',
		effort: 'Feel',
		effortHint: 'Tells you whether tomorrow should be a rest day.',
		efforts: { easy: 'Easy', steady: 'Moderate', tempo: 'Sustained', hard: 'Hard', max: 'Maximal' },
		whatItWorks: 'What it works',
		unfinished: 'Saved as it stands.',
		track: 'Track this run',
		byHand: 'Enter it by hand',
		switchToHand: 'Enter this one by hand instead',
		switchToTrack: 'Track this one instead',
		ready: 'Programme',
		start: 'Start',
		pause: 'Pause',
		resume: 'Resume',
		...
		splits: 'Kilometres',
		splitNumber: 'km {n}',
		splitPartial: 'in progress',
		noSplits: 'The first kilometre is still going.',
		waiting: 'Looking for the satellites.',
		noPermission: 'Location is turned off for the app, so a run cannot be tracked.',
		locationOff: 'Location is off on this phone. Turn it on and start again.',
		unsupported: 'This device cannot track a run. Enter it by hand instead.',
		browserOnly: 'In a browser the tracking stops when the tab sleeps. Install the app to run with the screen off.',
		block: 'Block',
		blockOf: '{n} of {of}',
		repeatOf: 'round {n} of {of}',
		...
		mapOn: 'Show map',
		mapOff: 'Hide map',
		mapCtrlZoom: 'Use ctrl and the wheel to zoom',
		mapCmdZoom: 'Use ⌘ and the wheel to zoom',
		...
		heartMax: 'peak {n}',
		bpmValue: '{n} bpm',
		alongDistance: 'By distance',
		alongTime: 'By time',
		exportGpx: 'Export as GPX',
		importGpx: 'Import a GPX file',
		importing: 'Reading the file',
		importFailed: 'No track in that file.',
		correct: 'Edit the figures'
	},
	workouts: {
		title: 'Programmes',
		hint: 'Sessions written in blocks, ready to run again.',
		empty: 'No programme written yet.',
		emptyHint: 'Blocks in order: warm up, the work, cool down.',
		...
		addRepeat: 'Add a repeat',
		repeat: 'Repeat',
		times: 'times',
		timesLabel: 'How many times',
		blockKinds: { warmup: 'Warm up', work: 'Work', recovery: 'Recovery', cooldown: 'Cool down' },
		goal: 'Ends on',
		goalTime: 'Time',
		goalDistance: 'Distance',
		goalOpen: 'Manual',
		metres: 'm',
		openHint: 'Runs until you say so.',
		...
		totalsOpen: '{distance} · {time} plus {n} open',
		blocks: '{n} blocks',
		deleteTitle: 'Delete this programme?',
		deleteBody: 'Runs already done keep their own copy.',
		outOfRange: 'A block is out of range. Check its time, distance or pace.',
		saved: 'Saved',
		useIt: 'Run this'
	},
