...
export const fr: Dictionary = {
	...
	score: {
		...
		plotHint: 'Touchez le point d’impact.',
		movePlot: 'Replacez la flèche entourée.',
		placePlot: 'Placez cette flèche sur le blason.',
		...
		previousEnd: 'Volée précédente',
		nextEnd: 'Volée suivante',
	...
	ianseo: {
		...
		countrySearch: 'Pays',
		peopleOffer: 'Vous cherchez un archer ?',
		searchPeople: 'Chercher dans les {n} documents',
		searchingPeople: 'Lecture du document {done} sur {n}',
		stopSearch: 'Arrêter',
		searchedPeople: '{done}/{n} documents lus.',
		...
		group: {
			individual: 'Individuel',
			team: 'Par équipes',
			entryList: 'Liste des inscrits',
			information: 'Informations',
			qualification: 'Tir de qualification',
			statistics: 'Statistiques',
			links: 'Liens',
			brackets: 'Phase finale : tableaux',
			finalRanking: 'Phase finale : classement',
			resultClass: 'Résultats par classe',
			medals: 'Médailles',
			resultsBook: 'Livret complet des résultats',
			roundRobin: 'Poules'
		},
		...
		noScheduleBody: 'Cette compétition n’a pas publié d’horaires. La page de la compétition liste ce qu’elle a publié.',
		scheduleUnreadableTitle: 'Ce programme ne se lit pas ici',
		scheduleUnreadableBody: 'ianseo imprime les horaires, et celui ci n’est pas mis en page comme cette version de l’app sait le lire. Le PDF contient tout.',
	...
	settings: {
		...
		themeSystem: 'Système',
		watch: 'Montre',
		watchHint: 'Marquez une volée au poignet. Le téléphone garde le relevé et calcule chaque score.',
		watchConnect: 'Connecter une montre',
		watchConnecting: 'Recherche d\'une montre',
		...
		watchNoApi: 'Ce navigateur ne peut pas connecter de montre. Chrome et Edge le peuvent ; Firefox et Safari n\'ont pas de Bluetooth.',
		watchInsecure: 'Une montre exige une connexion sécurisée. Ouvrez appchery.com plutôt qu\'une adresse de votre réseau.',
		watchNoAdapter: 'Le Bluetooth est éteint, ou cet appareil n\'en a pas.',
		...
		textScaleTitle: 'Taille du texte',
		textScaleHint:
			'Agrandit ou réduit toute l’app : le texte et les lignes et boutons autour de lui ensemble. La feuille de score garde sa part de l’écran quel que soit votre choix.',
		textScaleSmall: 'Plus petit',
		textScaleLarge: 'Plus grand',
...
insetHint:
	...
	running: {
		...
		kmh: 'km/h',
		effort: 'Sensations',
		effortHint: 'Indique si demain doit être un jour de repos.',
		efforts: { easy: 'Facile', steady: 'Modéré', tempo: 'Soutenu', hard: 'Difficile', max: 'Maximal' },
		whatItWorks: 'Ce que ça travaille',
		unfinished: 'Enregistré tel quel.',
		track: 'Suivre cette sortie',
		byHand: 'La saisir à la main',
		switchToHand: 'Plutôt la saisir à la main',
		switchToTrack: 'Plutôt la suivre au GPS',
		ready: 'Programme',
		start: 'Départ',
		pause: 'Pause',
		resume: 'Reprendre',
		...
		splits: 'Kilomètres',
		splitNumber: 'km {n}',
		splitPartial: 'en cours',
		noSplits: 'Le premier kilomètre est encore en cours.',
		waiting: 'Recherche des satellites.',
		noPermission: "La localisation est refusée à l'application : la sortie ne peut pas être suivie.",
		locationOff: 'La localisation est éteinte sur ce téléphone. Activez-la puis relancez.',
		unsupported: "Cet appareil ne peut pas suivre une sortie. Saisissez-la à la main.",
		browserOnly: "Dans un navigateur, le suivi s'arrête quand l'onglet s'endort. Installez l'application pour courir écran éteint.",
		block: 'Bloc',
		blockOf: '{n} sur {of}',
		repeatOf: 'série {n} sur {of}',
		...
		mapCtrlZoom: 'Ctrl et la molette pour zoomer',
		mapCmdZoom: '⌘ et la molette pour zoomer',
		mapTwoFingers: 'Deux doigts pour déplacer la carte',
	...
	workouts: {
		title: 'Programmes',
		hint: 'Des séances écrites en blocs, prêtes à refaire.',
		empty: 'Aucun programme écrit pour le moment.',
		emptyHint: "Des blocs dans l'ordre : échauffement, travail, retour au calme.",
		...
		addRepeat: 'Ajouter une série',
		repeat: 'Série',
		times: 'fois',
		timesLabel: 'Combien de fois',
		blockKinds: { warmup: 'Échauffement', work: 'Travail', recovery: 'Récupération', cooldown: 'Retour au calme' },
		goal: 'Fin du bloc',
		goalTime: 'Temps',
		goalDistance: 'Distance',
		goalOpen: 'Manuel',
		metres: 'm',
		openHint: "Court jusqu'à ce que vous le disiez.",
		targetPace: 'Allure visée',
		pacePlaceholder: '5:30',
		noPace: 'Aucune',
		label: 'Intitulé',
		labelPlaceholder: 'Facultatif',
		totals: '{distance} · {time}',
		totalsPace: '{distance} · {time} · {pace}',
		totalsOpen: '{distance} · {time} plus {n} libres',
		blocks: '{n} blocs',
		deleteTitle: 'Supprimer ce programme ?',
		deleteBody: 'Les sorties déjà faites gardent leur propre copie.',
		outOfRange: 'Un bloc est hors limites. Vérifiez son temps, sa distance ou son allure.',
		saved: 'Enregistré',
		useIt: 'Faire cette séance'
	},
