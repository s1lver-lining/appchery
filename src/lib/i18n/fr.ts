...
export const fr: Dictionary = {
	...
	auto: {
		...
		aiming: "Cadrez la cible pour voir tout le blason et son jaune.",
		noFace: 'Aucun blason détecté pour le moment.',
		settling: 'Mesure du blason. Placez-vous face à la cible pour la meilleure lecture.',
		angle: "Lire les flèches de biais est plus difficile. Placez-vous davantage face à la cible.",
