...
insetHint:
	...
	drill: {
		...
		hint: 'Tirer à une règle : une zone à toucher, une série à tenir, un chrono à battre.',
		setupHint: "Où cela se tire, et quelle est la règle. Le reste s'entre au fur et à mesure.",
		create: 'Commencer',
		trains: 'Ce que cela travaille',
		threshold: 'Zone de réussite',
		thresholdHint: 'Une flèche dans cet anneau ou plus au centre est réussie.',
		arrows: 'Flèches',
		arrowsOpen: 'Sans limite',
		arrowsOpenHint: "Continue jusqu'à ce que vous arrêtiez.",
		arrowsPerEnd: 'Flèches par volée',
		lives: 'Vies',
		livesHint: 'Le nombre de flèches hors zone autorisées avant la fin.',
		ladder: 'Anneaux à franchir',
		ladderHint: "Un anneau franchi ouvre le suivant. Une flèche ratée fait recommencer l'anneau en cours.",
		stepArrows: 'Flèches pour franchir un anneau',
		goal: 'Score à atteindre',
		seconds: 'Secondes',
		secondsHint: "Le chrono démarre quand vous le dites, pas à la création de l'exercice.",
		arrowSet: 'Flèches du jeu',
		arrowSetHint: 'Tirez-les dans le même ordre à chaque volée, pour que la flèche un reste la flèche un.',
		rate: 'Taux de réussite',
		hitsOf: '{hits} sur {arrows}',
		livesLeft: 'Vies restantes',
		bestStreak: 'Meilleure série',
		onNow: 'En cours : {n}',
		stepRing: 'Anneau à toucher',
		called: 'Annoncé : {ring}',
		callWaiting: 'Prêt pour la prochaine annonce',
		goalLeft: 'Encore {n} points',
		clock: 'Temps restant',
		...
		stopBody: "Il garde toutes les flèches déjà entrées et n'en prend plus.",
		reopen: 'Le reprendre',
		finished: 'Terminé',
		over: 'Cet exercice est terminé. Plus rien ne peut y entrer.',
		waiting: 'Attendez {n} s',
		ready: 'Tirez quand vous êtes prêt',
		waitHint: "Une flèche, puis on pose l'arc et on attend. La pause fait partie de l'exercice.",
		blindArrows: 'Flèches tirées',
		addArrows: 'Ajouter {n}',
		rating: 'Comment était cette volée',
		ratingHint: 'La seule lecture que donne une butte sans blason.',
		ratings: { 1: 'Affreux', 2: 'Laborieux', 3: 'Correct', 4: 'Bon', 5: 'Les meilleures' },
		meanRating: 'Ressenti',
		ranking: "Vos flèches, les plus à part d'abord",
		rankingHint: "Chaque tube est mesuré par rapport au reste du jeu et non par rapport au centre de la cible : un groupement entièrement à gauche, c'est un viseur à bouger, pas un tube à sortir du carquois.",
		rankingEmpty: "Pointez les flèches sur le blason et le tube à part se montrera. Les seuls chiffres ne peuvent que les classer au score.",
		arrowNo: 'Flèche {n}',
		...
		game: {
			successZone: {
				name: 'Zone de réussite',
				hint: 'Choisissez un anneau. Chaque flèche est réussie ou ratée, et ce qui revient est la fréquence.',
				trains: "Viser une exigence plutôt qu'un total, ce qu'un tir compté finit par masquer."
			},
			lives: {
				name: 'Vies',
				hint: "Tirez jusqu'à avoir manqué la zone une fois de trop. Ce que vous avez tenu fait le résultat.",
				trains: 'Tirer avec un enjeu sur chaque flèche.'
			},
			streak: {
				name: 'Série',
				hint: 'Quelle série de bonnes flèches vous arrivez à tenir. Une hors zone et la série tombe.',
				trains: "Tenir une exigence, ce qui est plus dur que de l'atteindre une fois."
			},
			shrinkingZone: {
				name: 'Zone dégressive',
				hint: "Un anneau franchi ouvre le suivant vers le centre. Allez aussi loin que possible.",
				trains: 'Relever votre propre barre, et découvrir où elle est vraiment.'
			},
			calledShot: {
				name: 'Anneau annoncé',
				hint: "L'application annonce un anneau avant chaque flèche. Toucher mieux reste un échec.",
				trains: "Viser là où on avait décidé, et non le centre par habitude."
			},
			targetScore: {
				name: 'Objectif de score',
				hint: 'Atteignez le score en le moins de flèches possible.',
				trains: "Faire compter chaque flèche, ce que demande un match."
			},
			beatTheClock: {
				name: 'Contre la montre',
				hint: 'Marquez le plus possible avant la fin du temps.',
				trains: 'Tirer en rythme, et garder son geste quand le chrono se fait entendre.'
			},
			arrowSorting: {
				name: 'Tri de flèches',
				hint: "Tirez le jeu dans l'ordre, pointez chaque flèche, et voyez quel tube part ailleurs.",
				trains: "Le réglage : cela trouve la flèche fautive au lieu d'en accuser l'archer."
			},
			blindBale: {
				name: 'Tir à blanc',
				hint: 'Les yeux fermés, face à une butte sans blason. Aucun score, seulement le ressenti.',
				trains: "Le geste, la cible retirée pour que plus rien ne tire le tir de côté."
			},
			onePressure: {
				name: 'Flèche unique',
				hint: 'Une flèche, une attente, puis une autre. Chaque flèche est seule.',
				trains: "La flèche qui décide d'un match, travaillée de la seule façon possible."
			}
		}
	},
	exercises: {
