...
export const fr: Dictionary = {
	...
	friends: {
		...
		actionFailed: 'Cela n’est pas passé. Vérifiez votre connexion et réessayez.',
		follow: 'Suivre',
		...
		emptyFeedBody: 'Suivez un archer, et ce qu’il choisit de partager apparaît ici.',
		...
		emptyFollowersBody: 'Donnez votre identifiant à quelqu’un et il pourra vous trouver.',
		nothingSharedTitle: 'Rien de partagé',
		nothingSharedBody: 'Cet archer n’a encore rien partagé.',
		nothingVisibleBody: 'Vous verrez ses partages une fois qu’il vous aura accepté.',
		status: {
			pending: 'Demandé',
			approved: 'Suivi'
		},
