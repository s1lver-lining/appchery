<script module lang="ts">
	...
	const SHAPES = {
		...
		watch: `
			<rect x="6.6" y="6.6" width="10.8" height="10.8" rx="3.2" class="f" />
			<path d="M9.4 6.6V4a.8.8 0 0 1 .8-.8h3.6a.8.8 0 0 1 .8.8v2.6" />
			<path d="M9.4 17.4V20a.8.8 0 0 0 .8.8h3.6a.8.8 0 0 0 .8-.8v-2.6" />
			<path d="M17.4 10.8h1.4" />`,
		calendar: `
