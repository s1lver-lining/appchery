 ...
 * round the gold. Turning this off gives up that too, and it should: the switch exists for a device the
 * sensors misbehave on, and it would be a poor escape hatch if something else went on using them.
 */
