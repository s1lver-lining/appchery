...
// ../src/lib/competitions/proxy.ts
var PROXY_PREFIX = "/competitions-api";
var IANSEO_ORIGIN = "https://www.ianseo.net";
var FFTA_ORIGIN = "https://www.ffta.fr";
var INSCRIPTARC_ORIGIN = "https://www.inscriptarc.fr";
var SOURCES = [
  {
    prefix: "/ianseo",
...
__name(sourceOf, "sourceOf");
function allowedPath(source, path) {
  return source.paths.some((pattern) => pattern.test(path));
}
__name(allowedPath, "allowedPath");
function targetOf(url, prefix = PROXY_PREFIX) {
...
// ../.wrangler/tmp/pages-AHm3U2/functionsRoutes-0.27699661137207865.mjs
var routes = [
  {
